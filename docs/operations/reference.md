---
title: "Claude Powerups detailed reference"
status: active
created: 2026-09-06
...
- **Everything must be universal.** No references to Misha's vault structure (personal vault, Body, Brand, etc.) in templates. All content is discovered through interviews or scans.
