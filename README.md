...
```bash
git clone https://github.com/Mykhailobabkin/claude-memory-setup.git
```
...
cp claude-memory-setup/SKILL.md ~/.claude/skills/claude-memory-setup.md
```
...
Type `/claude-memory-setup` or say:
